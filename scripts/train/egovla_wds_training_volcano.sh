...
TORCH_COMPILE_FORCE_PARAMETER_STATIC_SHAPES="${TORCH_COMPILE_FORCE_PARAMETER_STATIC_SHAPES:-true}"
...
TRAIN_COMMAND=(
    ...
    "torch_compile_force_parameter_static_shapes=$TORCH_COMPILE_FORCE_PARAMETER_STATIC_SHAPES"
    do_eval=true
    eval_strategy=steps
    eval_steps=500
